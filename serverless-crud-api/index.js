...
async function saveProduct(requestBody) {
  ...
  return await dynamodb
    ...
    .then(
      ...
      (error) => {
        console.error("Error occured saving the product: ", error);
      }
    );
}
...
async function updateProduct(productId, updateKey, updateValue) {
  ...
  return await dynamodb
    ...
    .then(
      ...
      (error) => {
        console.error("Error occured updating product: ", error);
      }
    );
}
...
async function deleteProduct(productId) {
  ...
  return await dynamodb
    ...
    .then(
      ...
      (error) => {
        console.error("Error occured deleting product: ", error);
      }
    );
}
